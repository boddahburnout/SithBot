...
public class Joints extends Command {
    String[] alias = new String[1];
    public Joints() {
        alias[0] = "joint";
        this.help = "Track your joint count";
    ...
    protected void execute(CommandEvent commandEvent) {
        ...
        try {
            ...
            int count = botConfig.getInt(configPath+".joints");
            ...
            if (args.length > 2) {
                MessageEmbed embed = new EmbedWrapper().EmbedMessage("Joint Counter", null, null,  color,"Use add/remove to alter the amounts", null, null,commandEvent.getSelfUser().getAvatarUrl(),null);
            ...
            if (args[0].equals("add")) {
                ...
                botConfig.set(configPath+".joints", count);
                msg = "Joint added to your counter your now at "+count;
            }
            if (args[0].equals("remove")) {
                ...
                if (count < 0) { count = 0; };
                botConfig.set(configPath + ".joints", count);
                msg = "Joint removed from your counter your now at " + count;
            }
            botConfig.save();
            MessageEmbed embed =  new EmbedWrapper().EmbedMessage("Joint Counter", null, null, color, msg, null, null, commandEvent.getSelfUser().getAvatarUrl(),  null);
            textChannel.sendMessageEmbeds(embed).queue();
        } catch (IOException e) {
